...
""" % bcb_dev)
  ...
  build_date = target_info.GetBuildProp("org.helios.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("org.helios.device")

  script.Print("----------------------------------------------");
  script.Print("              Helios-Project");
  script.Print("               by Yash");
  script.Print("----------------------------------------------");
